const
CoreString                      = require('superhero/core/string'),
coreString                      = new CoreString,
cwd                             = process.cwd(),
version                         = require(__dirname + '/../../package.json').version,
template_config                 = require('superhero/bin/superhero/file-template/config'),
template_config_api             = require('superhero/bin/superhero/file-template/config-api'),
template_config_domain          = require('superhero/bin/superhero/file-template/config-domain'),
template_config_infrastructure  = require('superhero/bin/superhero/file-template/config-infrastructure'),
template_testInit               = require('superhero/bin/superhero/file-template/test-init'),
template_gitignore              = require('superhero/bin/superhero/file-template/gitignore'),
template_packageJson            = require('superhero/bin/superhero/file-template/package-json'),
template_dockerfile             = require('superhero/bin/superhero/file-template/dockerfile'),
template_readme                 = require('superhero/bin/superhero/file-template/readme-md'),
template_main                   = require('superhero/bin/superhero/file-template/main'),
Fs                              = require('superhero/bin/superhero/fs'),
timezones                       = require('superhero/bin/superhero/timezones')
